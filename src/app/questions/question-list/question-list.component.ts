...
export class QuestionListComponent implements OnInit {
  questions: Question[] = [
    ...
    new Question('What do you think of jams made from raspberries?',
    ...
    new Question('Are you from New Zealand?',
      'Sometimes employers will want to know if you are from New Zealand, where people refer to themselves as' +
